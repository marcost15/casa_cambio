...
//if (bd_verificar_privilegios('estados_operaciones_eliminar.php',$_SESSION['usuario']['nivel_id'])!='CONCEDER')
//{
//  ir('negacion_usuario.php');
//}

$miscampos  = array("id","nombre","descripcion","creado","modificado");
$cantcampos = count($miscampos);

$n_datos            = bd_estados_operaciones_contar();
...
if( isset( $_REQUEST['p'] ) ){
    $datos = bd_estados_operaciones_datos21('id,nombre,descripcion,creado,modificado',$_REQUEST['p'],$n_datos_por_pagina);
} else {
    $datos = bd_estados_operaciones_datos2($i,$n_datos_por_pagina);
}
...
$smarty->assign('meta',proc_meta("estados_operaciones"));
$smarty->display("estados_operaciones_lista.html");
