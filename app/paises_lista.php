...
if( isset( $_REQUEST['p'] ) ){
    $datos = bd_paises_datos21('id,nombre,creado,modificado',$_REQUEST['p'],$n_datos_por_pagina);
} else {
    $datos = bd_paises_datos2($i,$n_datos_por_pagina);
}
...
$smarty->display("paises_lista.html");
