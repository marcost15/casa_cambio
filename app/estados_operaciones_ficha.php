...
//if (bd_verificar_privilegios('estados_operaciones_ficha.php',$_SESSION['usuario']['nivel_id'])!='CONCEDER')
//{
...
$antsig=bd_estados_operaciones_antsig($id);
...
$smarty->display("estados_operaciones_ficha.html");
