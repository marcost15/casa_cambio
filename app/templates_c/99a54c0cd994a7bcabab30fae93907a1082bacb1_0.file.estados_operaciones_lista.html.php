<?php /* Smarty version 3.1.27, created on 2017-08-20 05:42:58
         compiled from "C:\AppServ\www\casa_cambio\app\templates\estados_operaciones_lista.html" */ ?>
<?php
/*%%SmartyHeaderCode:28409599959a2bebc21_76440416%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '99a54c0cd994a7bcabab30fae93907a1082bacb1' => 
    array (
      0 => 'C:\\AppServ\\www\\casa_cambio\\app\\templates\\estados_operaciones_lista.html',
      1 => 1503222177,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '28409599959a2bebc21_76440416',
  'variables' => 
  array (
    'paginas' => 0,
    'pagina_actual' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_599959a2cb21f0_30211101',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_599959a2cb21f0_30211101')) {
function content_599959a2cb21f0_30211101 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '28409599959a2bebc21_76440416';
...
<div class="container">
	<div class="col-sm-6">
		<div class="page-header">
			<h1>Estados de Transacciones <a class="btn btn-default btn-lg" title="Agregar" href="#"
            onClick='eModal.iframe("estados_operaciones_agregar.php","Agregar Estados de Transacciones")'><i
    ...
    <div class="col-sm-6">
    <div class="page-header">
    <form action="estados_operaciones_lista.php" method="POST">
                <div class="input-group">
                  <span class="input-group-addon" id="basic-addon1" style="padding:0 12px;"><i class="fa fa-search"></i></span>
                  <input id="p" name="p" type="text" class="form-control" placeholder="Escriba aquí y pulse INTRO para buscar en Estados de Transacciones" aria-describedby="basic-addon1">
                </div>
            </form>
    </div>
    </div>
...
?>
            <option <?php if ($_smarty_tpl->tpl_vars['pagina_actual']->value == $_smarty_tpl->getVariable('smarty')->value['section']['ii']['iteration']) {?>selected="selected"<?php }?>
                value="estados_operaciones_lista.php?pag=<?php echo $_smarty_tpl->getVariable('smarty')->value['section']['ii']['iteration'];?>
...
<table id="tabla_estados_operaciones" style="width:100%;" border="1"
...
<th data-column-id="descripcion"><?php echo $_smarty_tpl->tpl_vars['meta']->value['descripcion']['etiqueta'];?>
</th>
...
<td><?php echo $_smarty_tpl->tpl_vars['datos']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['descripcion'];?>
</td>
...
<td><?php echo $_smarty_tpl->tpl_vars['datos']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['modificado'];?>
    ...
    <td class="text-center" style="white-space: nowrap;">
        <a style="margin-bottom:3px" class="btn btn-default" title="Ficha de Estados de Transacciones" href="#"
            onClick='eModal.ajax("estados_operaciones_ficha.php?id=<?php echo $_smarty_tpl->tpl_vars['datos']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['id'];?>
","Datos de Estados de Transacciones")'><i
            class="fa fa-info"></i></a>

        <a style="margin-bottom:3px" class="btn btn-default" title="Eliminar Estados de Transacciones" href="#"
            onClick='eModal.iframe("estados_operaciones_eliminar.php?id=<?php echo $_smarty_tpl->tpl_vars['datos']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['id'];?>
","Eliminar Elemento de Estados de Transacciones")'><i
            class="fa fa-trash-o"></i></a>

        <a style="margin-bottom:3px" class="btn btn-default" title="Modificar Estados de Transacciones" href="#"
            onClick='eModal.iframe("estados_operaciones_modificar.php?id=<?php echo $_smarty_tpl->tpl_vars['datos']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['id'];?>
","Modificación de Estados de Transacciones")'><i
