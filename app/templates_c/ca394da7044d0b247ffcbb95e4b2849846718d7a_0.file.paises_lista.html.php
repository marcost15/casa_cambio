<?php /* Smarty version 3.1.27, created on 2017-08-21 06:40:22
         compiled from "C:\AppServ\www\casa_cambio\app\templates\paises_lista.html" */ ?>
<?php
/*%%SmartyHeaderCode:27545599ab8965f81b7_78991752%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ca394da7044d0b247ffcbb95e4b2849846718d7a' => 
    array (
      0 => 'C:\\AppServ\\www\\casa_cambio\\app\\templates\\paises_lista.html',
      1 => 1503008554,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '27545599ab8965f81b7_78991752',
  'variables' => 
  array (
    'paginas' => 0,
    'pagina_actual' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_599ab8966a7951_88140517',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_599ab8966a7951_88140517')) {
function content_599ab8966a7951_88140517 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '27545599ab8965f81b7_78991752';
...
<div class="container">
	<div class="col-sm-6">
		<div class="page-header">
			<h1>Paises <a class="btn btn-default btn-lg" title="Agregar" href="#"
            onClick='eModal.iframe("paises_agregar.php","Agregar Paises")'><i
    ...
    <div class="col-sm-6">
    <div class="page-header">
    <form action="paises_lista.php" method="POST">
                <div class="input-group">
                  <span class="input-group-addon" id="basic-addon1" style="padding:0 12px;"><i class="fa fa-search"></i></span>
                  <input id="p" name="p" type="text" class="form-control" placeholder="Escriba aquí y pulse INTRO para buscar en paises" aria-describedby="basic-addon1">
                </div>
            </form>
    </div>
    </div>
...
?>
            <option <?php if ($_smarty_tpl->tpl_vars['pagina_actual']->value == $_smarty_tpl->getVariable('smarty')->value['section']['ii']['iteration']) {?>selected="selected"<?php }?>
                value="paises_lista.php?pag=<?php echo $_smarty_tpl->getVariable('smarty')->value['section']['ii']['iteration'];?>
...
<table id="tabla_paises" style="width:100%;" border="1"
...
<td><?php echo $_smarty_tpl->tpl_vars['datos']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['modificado'];?>
    ...
    <td class="text-center" style="white-space: nowrap;">
        <a style="margin-bottom:3px" class="btn btn-default" title="Ficha de paises" href="#"
            onClick='eModal.ajax("paises_ficha.php?id=<?php echo $_smarty_tpl->tpl_vars['datos']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['id'];?>
","Datos de Paises")'><i
            class="fa fa-info"></i></a>

        <a style="margin-bottom:3px" class="btn btn-default" title=""Eliminar paises" href="#"
            onClick='eModal.iframe("paises_eliminar.php?id=<?php echo $_smarty_tpl->tpl_vars['datos']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['id'];?>
","Eliminar Elemento de Paises")'><i
            class="fa fa-trash-o"></i></a>

        <a style="margin-bottom:3px" class="btn btn-default" title="Modificar paises" href="#"
            onClick='eModal.iframe("paises_modificar.php?id=<?php echo $_smarty_tpl->tpl_vars['datos']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['id'];?>
","Modificación de Paises")'><i
